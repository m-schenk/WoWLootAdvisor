    ...
    Player.findById(req.user._id)
        .then(player => {
            if (player.wishlist.locked) {
                ...
                player.wishlist.bracket1 = req.body.wishlist.bracket1;
                player.wishlist.bracket2 = req.body.wishlist.bracket2;
                player.wishlist.bracket3 = req.body.wishlist.bracket3;
                player.wishlist.bracket4 = req.body.wishlist.bracket4;
                player.wishlist.bracketLess = req.body.wishlist.bracketLess;
                player.save()
                .then(player => {
                    res.status(200);
                    res.set({ 'Content-Type': 'text/json' });
